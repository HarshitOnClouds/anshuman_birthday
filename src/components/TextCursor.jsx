...
const TextCursor = ({
  ...
  const handleMouseMove = (e) => {
    // Use viewport coordinates directly instead of container-relative coordinates
  ...
  useEffect(() => {
    // Attach mouse listener to document instead of container for full screen coverage
